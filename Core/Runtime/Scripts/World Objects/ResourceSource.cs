...
//         public List<CharacterBehavior> assignedCharacters;
...
//             base.Start();
//             assignedCharacters = new List<CharacterBehavior>();
...
//         }
//         public void AssignCharacter(CharacterBehavior character) {
...
//             }
//         }
//         public void UnassignCharacter(CharacterBehavior character) {
//             if (assignedCharacters.Contains(character)) {
...
//             foreach (CharacterBehavior character in assignedCharacters) {
//                 character.currentSelection = null;
//             }
...
//                 BehaviorTreeBehavior _bt = _playerController.character.bt;
//                 _bt.context.SetContext("resourceSource", this);
//                 // _bt.SetManualNode(WorkBT.WorkResourceSourceSequence(_bt.context));
//             } else if (selector.GetComponent<CharacterBehavior>() != null) {
...
//                 foreach (CharacterBehavior _char in assignedCharacters) {
