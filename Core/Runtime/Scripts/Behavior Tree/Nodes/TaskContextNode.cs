namespace Lord.Core {
    ...
    public class TaskContextNode : Node {
        ...
        public delegate NodeStates ActionNodeDelegate(BehaviorContext context);
        ...
        public TaskContextNode(ActionNodeDelegate action, string nodeName = "<node>") {
            m_action = action;
        ...
        public override NodeStates Evaluate() {
            switch (m_action(new BehaviorContext())) {
